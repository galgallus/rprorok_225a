...
saveRDS(Tcells, fil = "../processed_data/Tcells_analyzed.rds")
```

```{r }
#Colored with CD4s lighter and CD8s darker 
dittoDimPlot(object = Tcells, var = "Tage", size = 1.5, reduction.use = "umap", colors = c(1,9,10,2,11,3), main = "T cells lineage and age")
...
#proof of concept for fuction below
#Tcells$Tage == tage[1]
